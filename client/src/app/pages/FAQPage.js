            ...
            <div className="row text-center">
                ...
                <div className="col-lg-4 mb-5 mb-lg-0">
                    <span className="card card-link border-top border-top-lg border-green h-100 lift" ><div className="card-body p-5">
                            <div className="icon-stack icon-stack-lg bg-green-soft text-green mb-4"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-clock"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg></div>
                            <h6>Integrations</h6>
